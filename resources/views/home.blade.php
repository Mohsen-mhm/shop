...
@section('content')
    ...
    <div class="container">
        <div class="text-center mt-2 mb-2 d-flex flex-column text-light">
            ...
            <p>منظره ای رویایی در بالا ترین نقطه منطقه و چشم اندازی زیبا که با غروبی دلنشین در قاب تراس کافه هنرمندانه آمیخته شده است تا شما را محو تماشای آن کنیم.</p>
        </div>
